...
@section('breadcrumb-items')
        ...
        <li class="breadcrumb-item"><a href="{{ route('listado_productos')}}">Listado de productos</a></li>  
         <li class="breadcrumb-item"><a href="{{ route('mostrar_producto', ['id' => $producto->id]) }}">Actualizar producto</a></li> 
